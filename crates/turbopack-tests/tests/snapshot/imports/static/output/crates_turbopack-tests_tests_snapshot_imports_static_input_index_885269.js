(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push([
    ...
    {},
    {"otherChunks":[{"path":"output/crates_turbopack-tests_tests_snapshot_imports_static_input_index_b53fce.js","included":["[project]/crates/turbopack-tests/tests/snapshot/imports/static/input/index.js (ecmascript)"]}],"runtimeModuleIds":["[project]/crates/turbopack-tests/tests/snapshot/imports/static/input/index.js (ecmascript)"],"chunkListPath":"output/crates_turbopack-tests_tests_snapshot_imports_static_input_index.js_f5704b._.json"}
]);
(() => {
 ...
 *
 * @param {ChunkPath} chunkListPath
 * @param {ChunkData[]} chunksData
 */
function registerChunkList(chunkListPath, chunksData) {
 ...
 * @param {ChunkData[]} chunksData
 */
function registerChunkListAndMarkAsRuntime(chunkListPath, chunksData) {
  registerChunkList(chunkListPath, chunksData);
